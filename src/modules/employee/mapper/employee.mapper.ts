import {
  formatTimeStamp,
  formatTimeUtil,
} from 'src/shared/utils/formatTime.util';
...
export class EmployeeMapper {
  static toDomain(entity: EmployeeEntity): Employee {
    return new Employee({
      ...
      district: entity.district
        ...
        : null,
     educations: entity.educations?.map((education) => Employee_educationMapper.toDomain(education)) ?? [],
  ...
  static toResponse(domain: Employee) {
    ...
    return {
      ...
      user_id: domain.user ? domain.user.id : null,
      ...
      educations: domain.educations
        ? domain.educations.map((education) =>
            Employee_educationMapper.toResponse(education),
          )
        : [],
